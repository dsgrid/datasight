...
def format_schema_context(
    ...
    parts.append("- After running a query, if a visualization would help, call visualize_data")
    parts.append("  with the same or adapted SQL query.")
    ...
    parts.append("- Use DuckDB SQL syntax.")
