<script lang="ts">
  ...
  const shortcuts = [
    ...
    { key: "1 / 2 / 3", desc: "Switch to Chat / Dashboard / SQL" },
    { key: "D", desc: "Toggle chat / dashboard" },
    { key: "S", desc: "Toggle chat / SQL editor" },
    { key: "E", desc: "Toggle export mode" },
    { key: "H", desc: "Toggle query history panel" },
    { key: "P", desc: "Pin latest result (or unpin selected card)" },
    { key: "F", desc: "Fullscreen selected card (dashboard)" },
    { key: "G", desc: "Focus schema inspector search" },
    { key: "J / K", desc: "Next / previous message (or card)" },
    { key: "[ / ]", desc: "Previous / next conversation" },
