...
[Set up a project](../../project-setup/tutorials/set-up-project.md#configure) for alternative
configurations.
...
- [Configure semantic measures](../../project-setup/how-to/configure-measures.md) — override
